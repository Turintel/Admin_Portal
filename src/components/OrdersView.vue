  ...
  <div class="orders-view">
    ...
    <div class="toolbar-container">
      <div class="toolbar-content">
        <h1 class="page-title text-2xl font-bold text-slate-800">Admin Portal</h1>
        <div class="toggle-buttons">
          <!-- Existing Active/Archived Orders toggle buttons -->
          ...existing code...
        </div>
      </div>
...
.toolbar-container {
  ...
  padding: 20px;
  margin-bottom: 24px;
  margin-top: 0; /* Adjusted to sit flush against the top */
}
